    ...
    <div class="wrap">
        ...
        <form method="post" action="">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <input name="preowned_clothing_github_repository" type="text"
                            id="preowned_clothing_github_repository" value="<?php echo esc_attr($repository); ?>"
                            class="regular-text">
                        <p class="description">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">
                            Required for private repositories. <a
                                href="https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token"
                                target="_blank">Learn how to create a token</a>.
        ...
        <?php if (isset($test_result)): ?>
            <div class="github-test-result">
                <h2><?php echo isset($test_result['phase']) && $test_result['phase'] == 'repository_check' ? 'Repository Verification Result' : 'GitHub Releases Test Result'; ?>
                </h2>
                    ...
                    <div class="notice notice-error">
                        ...
                        <?php if (strpos($test_result['error'], '404') !== false): ?>
                            <div class="error-help">
                                ...
                                <ol>
                                    <li>Verify that the repository exists: <a
                                            href="https://github.com/<?php echo esc_attr($test_username); ?>/<?php echo esc_attr($test_repository); ?>"
                                            target="_blank">https://github.com/<?php echo esc_attr($test_username); ?>/<?php echo esc_attr($test_repository); ?></a>
                                    </li>
                                    ...
                                    <li>Confirm that the repository has at least one release: <a
                                            href="https://github.com/<?php echo esc_attr($test_username); ?>/<?php echo esc_attr($test_repository); ?>/releases"
                                            target="_blank">View Releases</a></li>
                                </ol>
                            </div>
        ...
        <div class="github-updater-troubleshooting">
            ...
            <h3>Common Issues</h3>
            <ul>
                <li><strong>404 Not Found</strong>: The repository or releases page was not found. Check the username and
                    repository name.</li>
                <li><strong>401 Unauthorized</strong>: Your token doesn't have the right permissions.</li>
                <li><strong>No releases found</strong>: You need to create <a
                        href="https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository"
                        target="_blank">at least one release</a> on GitHub.</li>
            </ul>
            ...
            <ul>
                ...
                <li>The repository should contain a valid WordPress plugin with the same version number in its main file
                </li>
            </ul>
        </div>
...
function preowned_clothing_github_help_section()
{
    ...
    <div class="github-updater-help">
        ...
        <div class="help-section">
            ...
            <p><strong>Note:</strong> The version tag (without the "v" prefix) should match the version number in your
                plugin's main PHP file.</p>
        </div>
        ...
        <div class="help-section">
            ...
            if (!empty($username) && !empty($repository)):
                ?>
                <ul>
                    <li><a href="https://github.com/<?php echo esc_attr($username); ?>/<?php echo esc_attr($repository); ?>/releases/new"
                            target="_blank">Create a New Release</a></li>
                    <li><a href="https://github.com/<?php echo esc_attr($username); ?>/<?php echo esc_attr($repository); ?>/releases"
                            target="_blank">View All Releases</a></li>
                    <li><a href="https://github.com/<?php echo esc_attr($username); ?>/<?php echo esc_attr($repository); ?>/tags"
                            target="_blank">View Tags</a></li>
                </ul>
            <?php else: ?>
    ...
    <div style="margin: 15px 0;">
        ...
        <p>
            <a href="https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository"
                target="_blank" class="button">GitHub Releases Documentation</a>
...
function preowned_clothing_updater_release_notice()
{
    ...
    if (empty($username) || empty($repository)) {
        ...
        <div class="notice notice-info is-dismissible" id="preowned-clothing-release-notice">
            ...
            <p>Simply <a href="<?php echo admin_url('options-general.php?page=preowned-clothing-github-updater'); ?>">configure
                    your repository details</a> to get started.</p>
    ...
    <div class="wrap">
        ...
        <div class="card">
            ...
            <ul>
                ...
                <li>Repository: <?php echo esc_html(get_option('preowned_clothing_github_repository', 'Clothing_Form')); ?>
                </li>
